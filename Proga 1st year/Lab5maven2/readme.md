# Лабораторная №5 :exploding_head:
<p align="center">
  <img src="../../gifs/skeleton-working.gif" width = 400>
</p>
...
public class Coordinates {
    private long x; //Максимальное значение поля: 222
    private float y; //Значение поля должно быть больше -471
}
